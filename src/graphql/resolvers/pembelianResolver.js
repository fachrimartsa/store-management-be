...
const pembelianResolver = {
  getAllPembelian: async () => {
    try {
      return await pembelianService.getAllPembelian();
    } catch (error) {
  ...
  createPembelian: async ({ pbl_tanggal, pbl_barang, pbl_supplier, pbl_jumlah, pbl_alamat, pbl_harga_beli, pbl_total }) => {
    try {
      return await pembelianService.createPembelian({ pbl_tanggal, pbl_barang, pbl_supplier, pbl_jumlah, pbl_alamat, pbl_harga_beli, pbl_total });
    } catch (error) {
  ...
  updatePembelian: async ({ pbl_id, pbl_tanggal, pbl_barang, pbl_supplier, pbl_jumlah, pbl_alamat, pbl_harga_beli, pbl_total }) => {
    try {
      return await pembelianService.updatePembelian({ pbl_id, pbl_tanggal, pbl_barang, pbl_supplier, pbl_jumlah, pbl_alamat, pbl_harga_beli, pbl_total });
    } catch (error) {
