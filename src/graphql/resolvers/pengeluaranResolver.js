...
const pengeluaranResolver = {
  getAllPengeluaran: async () => {
    try {
      return await pengeluaranService.getAllPengeluaran();
    } catch (error) {
  ...
  createPengeluaran: async ({ pgl_tanggal, pgl_barang, pgl_jumlah, pgl_total }) => {
    try {
      return await pengeluaranService.createPengeluaran({ pgl_tanggal, pgl_barang, pgl_jumlah, pgl_total });
    } catch (error) {
  ...
  updatePengeluaran: async ({ pgl_id, pgl_tanggal, pgl_barang, pgl_jumlah, pgl_total }) => {
    try {
      return await pengeluaranService.updatePengeluaran({ pgl_id, pgl_tanggal, pgl_barang, pgl_jumlah, pgl_total });
    } catch (error) {
